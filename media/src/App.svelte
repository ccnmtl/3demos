<script>
  ...
  import { drawAxes, drawGrid, labelAxes, makeHSLColor } from "./utils";
  import {
    makeObject,
    removeObject,
    updateObject,
      ...
      <div class="collapse-info" hidden={shadeUp}>
        <div class="object-box-title d-flex">
          <ButtonDropdown class="mb-1">
            ...
            <DropdownMenu>
              <DropdownItem on:click={() => (currentChapter = "Intro")}>
                Intro
              </DropdownItem>
              <DropdownItem on:click={() => (currentChapter = "Chapter")}>
                Arc Length & Curvature
              </DropdownItem>
              <DropdownItem on:click={() => (currentChapter = "Linear")}>
                Linearization
              </DropdownItem>
            </DropdownMenu>
          </ButtonDropdown>
          ...
          <ButtonDropdown class="ms-1">
            <DropdownToggle caret class="btn btn-light">Modes</DropdownToggle>
            <DropdownMenu>
              <DropdownItem
            ...
            <DropdownMenu>
              <DropdownItem
                on:click={() => {
                  ...
                  console.log("trying activate");
                  currentActiveObject = objects[objects.length - 1].uuid;
                  console.log("active o ", currentActiveObject);
                }}
              >
        ...
        <div class="objectBoxInner">
          {#each objects as b}
            <div
              ...
              class:active-object={currentActiveObject === b.uuid}
            >
              {#if b.kind === "parsurf"}
                <ParSurf
                  {scene}
                  ...
                  params={b.params}
                  onClose={() =>
                    (objects = removeObject(b.uuid, objects, socket))}
