...
<article>
    ...
    <p>
        This site is an open source project released under the GPL license.
        <a href="https://github.com/ccnmtl/3demos/">See the GitHub repository
        for more information</a>. Much credit must go to the authors and
        contributors of the brilliant <a href="https://threejs.org/">three.js
        library</a> for the graphics (and, by extension, WebGL itself) as well
        as <a href="https://mathjs.org">math.js</a> for the math parsing and
        processing.
    </p>
    <p>
        Special appreciation is extended to
        <a href="https://ctl.columbia.edu">Columbia University's Center for
        Teaching and Learning</a>, which made significant contributions to
    ...
    <p>
        Finally, the pioneering work of Paul Seeburger and his
        <a href="https://c3d.libretexts.org/CalcPlot3D/index.html">CalcPlot3D</a>
        project deserves acknowledgment, as it covers much of the 
