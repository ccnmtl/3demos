<script>
    ...
    export let tanFrame, arrows, arrowParams, planeShard;
    ...
    const updateSurface = function () {
        ...
        if (surfaceMesh) {
            ...
            surfaceMesh = new ParametricSurface();
    ...
    export const tangentVectors = function ({ uv, eps = 1e-4, plane = true } = {}) {
